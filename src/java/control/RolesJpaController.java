...
public class RolesJpaController implements Serializable {
    ...
    public void create(Roles roles) throws PreexistingEntityException, Exception {
        ...
        roles.getRolesPK().setIdCategoria(roles.getItem().getItemPK().getIdCategoria());
        roles.getRolesPK().setIdItem(roles.getItem().getItemPK().getItem());
        ...
        try {
            ...
            if (item != null) {
                item = em.getReference(item.getClass(), item.getItemPK());
                roles.setItem(item);
            }
            em.persist(roles);
            if (grupo != null) {
    ...
    public void edit(Roles roles) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (itemNew != null) {
                itemNew = em.getReference(itemNew.getClass(), itemNew.getItemPK());
