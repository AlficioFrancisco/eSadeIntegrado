...
////Machauma/////////////////////////////////////////////////////////////
    ...
    @Wire
    Textbox descricao,nomeCompleto;
    @Wire
    Radiogroup rd;
...
//    }
          ...
          Clients.showNotification("Informe o codigo do parametro!", "warning", null, null, 3000);
           ...
           if(isCodigo(codi))
               ...
               try {
                    ...
                    Clients.showNotification("parameto adicionado com successo!", "Success", null, null, 3000);
                    codigo.setValue("");
                    descricao.setValue("");
               } catch (Exception e) {
          ...
          Clients.showNotification("Informe o Utilizador!", "warning", null, null, 3000);
           ...
           if(isCodigo(codi))
            ...
            user.setIdEstudante((Estudante) comboestud.getSelectedItem().getValue());    
               ...
               user.setIddocente((Docente) comboprofeso.getSelectedItem().getValue());
               try {
    ...
    ListModelList<Docente> listprofessor=new ListModelList<Docente>(new DocenteJpaController(new Jpa().getEmf()).findDocenteEntities());
