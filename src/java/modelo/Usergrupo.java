 ...
 */
@Entity
@Table(name = "usergrupo", catalog = "integra", schema = "esira")
@XmlRootElement
@NamedQueries({
...
public class Usergrupo implements Serializable {
    ...
    public Usergrupo(String idGrupo, String utilizador) {
        this.usergrupoPK = new UsergrupoPK(idGrupo, utilizador);
    }
    ...
    public String toString() {
        return "modelo.Usergrupo[ usergrupoPK=" + usergrupoPK + " ]";
    }
