 ...
 */
@Embeddable
public class NotapautaOldPK implements Serializable {
    ...
    public NotapautaOldPK() {
    }

    public NotapautaOldPK(long iddisc, int ano, short semestre, Date datap, long idestudante) {
        this.iddisc = iddisc;
        this.ano = ano;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NotapautaOldPK)) {
            return false;
        }
        NotapautaOldPK other = (NotapautaOldPK) object;
    ...
    public String toString() {
        return "modelo.NotapautaOldPK[ iddisc=" + iddisc + ", ano=" + ano + ", semestre=" + semestre + ", datap=" + datap + ", idestudante=" + idestudante + " ]";
    }
